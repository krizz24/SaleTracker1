...
public class CameraPreviewActivity extends AppCompatActivity {
     ...
     */
    private CameraPreviewActivity.AddressResultReceiver mResultReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mResultReceiver = new CameraPreviewActivity.AddressResultReceiver(new Handler());

//        mLocationAddressTextView = (TextView) findViewById(R.id.location_address_view);
//        mProgressBar = (ProgressBar) findViewById(R.id.progress_bar);
//        mFetchAddressButton = (Button) findViewById(R.id.btn_check_in);
        mCameraPreview = findViewById(R.id.imageView);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA) {
            ...
            mCameraPreview.setImageBitmap(photo);
        }
    ...
    private void startIntentService() {
        ...
        intent.putExtra(com.example.saletracker1.attendance.Constants.RECEIVER, mResultReceiver);

        // Pass the location data as an extra to the service.
        intent.putExtra(com.example.saletracker1.attendance.Constants.LOCATION_DATA_EXTRA, mLastLocation);
